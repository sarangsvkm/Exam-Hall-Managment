        ...
        <div class="widget-box">
          ...
          @csrf
                    ...
                    <div class="control-group">
                        ...
                        <div class="controls">
                            <input type="text" name="name" id="p_name" class="form-control" value="{{$exam->name}}" title=""
                    ...
                    <div class="control-group">
                        ...
                        <div class="controls">
                            <input type="date" name="exam_date" id="p_name" class="form-control" value="{{$exam->exam_date}}" title=""
                                required="required" style="width: 400px;">
                            <span class="text-danger"></span>
                        </div>
                    </div>
                    <div class="control-group">
                        ...
                        <div class="controls">
                            <input type="time" name="start_time" id="p_name" class="form-control" value="{{$exam->start_time}}" title=""
                                required="required" style="width: 400px;">
                            <span class="text-danger"></span>
                        </div>
                    </div>
                    <div class="control-group">
                        ...
                        <div class="controls">
                            <input type="time" name="end_time" id="p_name" class="form-control" value="{{$exam->end_time}}" title=""
                                required="required" style="width: 400px;">
                            <span class="text-danger"></span>
                        </div>
                    </div>
