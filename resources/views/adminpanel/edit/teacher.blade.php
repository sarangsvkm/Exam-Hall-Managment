                ...
                <form action="" method="post" class="form-horizontal" enctype="multipart/form-data">
                   @csrf
                    ...
                    <div class="control-group">
                        ...
                        <div class="controls">
                            <input type="text" name="tfname" id="p_name" class="form-control" value="{{$teacher->tfname}}" title=""
                                required="required" style="width: 400px;">
                            <span class="text-danger"></span>
                        </div>
                    </div>
                    <div class="control-group">
                        ...
                        <div class="controls">
                            <input type="text" name="tlname" id="p_name" class="form-control" value="{{$teacher->tlname}}" title=""
                                required="required" style="width: 400px;">
                            <span class="text-danger"></span>
                        </div>
                    </div>
                    <div class="control-group">
                        ...
                        <div class="controls">
                            <input type="temail" name="temail" id="p_name" class="form-control" value="{{$teacher->temail}}" title=""
                                required="required" style="width: 400px;">
                            <span class="text-danger"></span>
                        </div>
                    </div>
                    ...
                    <div class="control-group">
                        ...
                        <div class="controls">
                            <input type="date" name="tdob" id="p_name" class="form-control" value="{{$teacher->tdob}}" title=""
                                required="required" style="width: 400px;">
                            <span class="text-danger"></span>
                        </div>
                    </div>
                    <div class="control-group">
                        ...
                        <div class="controls">
                            <input type="text" name="taddress" id="p_name" class="form-control" value="{{$teacher->taddress}}" title=""
                                required="required" style="width: 400px;">
                            <span class="text-danger"></span>
                        </div>
                    </div>
                    <div class="control-group">
                        ...
                        <div class="controls">
                            <input type="text" name="tcontact" id="p_name" class="form-control" value="{{$teacher->tcontact}}" title=""
                                required="required" style="width: 400px;">
                            <span class="text-danger"></span>
                        </div>
                    </div>
